...
export function ContactFooter() {
  ...
  return (
    <>
      ...
      <section
        id="contato"
        className="relative isolate w-full max-w-full min-w-0 scroll-mt-20 overflow-x-visible overflow-y-visible bg-forest-dark py-24 text-paper md:scroll-mt-24 md:py-28 lg:h-screen lg:py-10"
      >
